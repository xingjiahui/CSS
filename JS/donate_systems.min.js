/*!
 * donate_system v1.0.0
 * (c) 2020-2020 xCss
 * Released under the GPL-2.0 License.
 * Last Update: 2020/6/1 上午11:35:51:
 */
...
var outWayArray=outWay.split("、");if(payWay=="微信"){document.getElementsByTagName("tr")[i].getElementsByTagName("td")[1].style.color="rgb(60,176,53)"
...
for(var j=0;j<outWayArray.length;j++){document.getElementsByTagName("tr")[i].getElementsByTagName("td")[3].innerHTML+="<span class='inline-tag yellow'>"+outWayArray[j]+"</span>&nbsp;"
